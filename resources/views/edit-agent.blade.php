...
<body>
    ...
    <section class="p-4 my-container">
        ...
        <form method="POST" action="{{ url('/agents/'.$agent->id) }}">
        @csrf
        <div class="form-group">
            <label for="name">Name</label>
            <input id="name" type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ $agent->name }}" required autocomplete="name" autofocus>
            @error('name')
        ...
        <div class="form-group">
            ...
            <input id="email" type="email" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ $agent->email }}" required autocomplete="email">
