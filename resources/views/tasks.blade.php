...
<style>
    *{
    ...
    .popup-content {
      ...
      #title,#description,#limit_time,#creation_time{
        padding : 20px;
        font-size : 16px;
...
<body>
    ...
    <section class="p-4 my-container">
        ...
        <button class="btn btn-secondary" id="showPopup">Add Tasks</button>
...
<div class="popup-container" id="popupContainer">
  <div class="popup-content">
    ...
    <form action="{{url('tasks')}}" method="post">
        ...
        <input id="title" class="form-control mt-2" type="text" name="title" ><br>
        
        <label for="description">Task Description :</label>
        <input id="description" class="form-control mt-2" type="text" name="description" >

        <input type="hidden" name="responsable_id" value="{{ Auth::user()->id }}" class="form-control mt-2"><br>
        
        <label for="creation_time">Creation Time :</label>
        <input id="creation_time" type="date" name="creation_time" class="form-control mt-2"> <br>

        <label for="limit_time">Limit Time :</label>
        <input id="limit_time" type="date" name="limit_time" class="form-control mt-2">

        <input readonly type="hidden" name="status" value="to do" class="form-control mt-2"><br>

        
        <label for="agent_id">Assigned to :</label>
        <select id="agent" name="agent_id" class="form-control mt-2">
            @foreach($agents as $agent)
                <option value="{{ $agent->id }}">{{ $agent->name }}</option>
            @endforeach
        </select>
        
       <br> <button id="createBtn" class="btn btn-primary mt-3" type="submit">Create</button>
    </form>
