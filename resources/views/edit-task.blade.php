...
<body>
    ...
    <section class="p-4 my-container">
        ...
        <div class="form-group">
            ...
            <input id="description" type="text" class="form-control @error('description') is-invalid @enderror" name="description" value="{{ $task->description }}" required autocomplete="description">
            ...
            <div class="form-group">
            <label for="description">Limit Time</label>
            <input id="description" type="text" class="form-control @error('limit_time') is-invalid @enderror" name="limit_time" value="{{ $task->limit_time }}" required autocomplete="limit_time">
        ...
        <button type="submit" class="btn update-btn btn-outline-primary">
            {{ __('Update') }}
        </button>
