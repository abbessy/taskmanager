...
<nav class="navbar navbar-expand d-flex flex-column align-item-start" 
    ...
    <section class="p-4 my-container">
        ...
        <form method="POST" action="{{ url('agent/comments/'.$task->id) }}">
        @csrf
        

            <div class="form-group">
            <label for="comment">Comment</label>
            <input id="comment" type="text" class="form-control @error('comment') is-invalid @enderror" name="comment" value="{{ $task->comment }}" autocomplete="comment">
