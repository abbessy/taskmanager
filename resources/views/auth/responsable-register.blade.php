...
<body>
    ...
    <div class="row d-flex justify-content-center align-items-center h-100">
      ...
      <div class="col-md-8 col-lg-6 col-xl-4 offset-xl-1 my-5">
        <form method="POST" action="{{ route('responsableAccept')}}">
            @csrf

            <input type="hidden" value="responsable" name="user_type">

            <input readonly type="hidden" value="{{$invite->client_id}}" name="client_id">
