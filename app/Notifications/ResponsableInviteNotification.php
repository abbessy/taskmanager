...
class ResponsableInviteNotification extends Notification
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        return (new MailMessage)
            ->greeting('Greetings Mr Responsable!')
            ->line('This is to invite you to join our platform LaraProject' )
            ->action('Register Now',$this->notification_url)
